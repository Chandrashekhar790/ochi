...
const Footer = () => {
  return (
    <div className="w-full h-screen py-16 px-14 flex bg-zinc-700">
      <div className=" first-side w-1/2 h-full flex flex-col justify-between">
        <div>
          <h1 className="main text-[9vw] uppercase leading-none -mb-5">eye-</h1>
          <h1 className="main text-[9vw] uppercase leading-none -mb-5">
            opening
          </h1>
        </div>
      ...
      <div className="w-1/2 second-side ">
        <h1 className="main text-[9vw] uppercase leading-none -mb-5">
          presentations
        </h1>
          ...
          <div className="w-1/2">
            <div className="flex flex-col mt-20">
              {["instagram", "behance", "facebook", "linkedin"].map(
                (item, index) => (
                  <a href="" className="manu capitalize">
                    {item}
                  </a>
                )
              )}
            ...
            <div className="flex flex-col mt-16">
              {[
                ...
                <a
                  href=""
                  className={`manu capitalize ${index === 2 && "mt-5"}`}
                >
                  {item}
                </a>
              ))}
          ...
          <div className="w-1/2 flex justify-end items-center">
            <div className="flex flex-col mt-20">
              {["Home", "Services", "Our work", "About us", "Insights", "Contact us"].map(
                (item, index) => (
                  <a href="" className="manu capitalize hover:underline underline-offset-4">
                    {item}
                  </a>
                )
              )}
