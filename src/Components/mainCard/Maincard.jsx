...
const Maincard = () => {
  return (
    <div className="w-full flex px-10 gap-5 bg-zinc-900">
      <div className="w-1/2 h-[70vh]  py-10">
        <div className="bg-[#004D43] w-full h-full rounded-xl relative">
          <svg
            className="absolute text-[#CDEA68] left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%]"
            width="150"
            height="108"
            viewBox="0 0 72 30"
            fill="none"
          ...
          <button className="uppercase manu text-sm border-[1px] border-[#CDEA68] ml-[2vw] text-[#CDEA68] mt-[22vw] py-2 px-4 rounded-full">
            &copy; 2019-2022
          </button>
        </div>
      </div>

      <div className="w-1/2 h-[70vh]   py-10 flex gap-5">
        <div className="bg-[#212121] w-full h-full rounded-xl relative">
          
          
          <img
            src="../clut.svg"
            alt=""
            className="h-[5vw] w-[10vw] absolute left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%]"
          />


          <button className="uppercase manu text-sm border-[1px] border-white ml-[2vw] text-white mt-[22vw] py-2 px-4 rounded-full">
        ...
        <div className="bg-[#212121] w-full h-full rounded-xl relative">
          <img
            src="../log.png"
            alt=""
            className="h-24 w-24 absolute left-1/2 top-1/2 -translate-x-[50%] -translate-y-[50%]"
          />
          <button className="uppercase manu text-sm border-[1px] border-white ml-[2vw] text-white mt-[22vw] py-2 px-4 rounded-full">
